...
public class Chessman : MonoBehaviour
{
    ...
    //Variable to check if for black or white
    private string player;

    //References for all sprites chess pieces can be
    ...
    {
        //Get access tho GameController controller in Unity
        controller = GameObject.FindGameObjectWithTag("GameController");

        //Take Location and transform
        SetCoords();
